        ...
        <tbody>
          {dummyData.map((item, index) => (
            <tr key={index} className="border-t border-t-[#F2F4F6] text-gray-700 text-sm">
              <td className="p-3 font-bold pl-8">{item.product}</td>
              <td className="p-3 font-bold">{item.quantity}</td>
              <td className="p-3 font-bold text-[#E55541]">{item.bidPrice.toFixed(2)}</td>
              <td className="p-3 font-bold">
                <button className="border border-[#E55541] text-[#E55541] px-6 py-1 rounded-md cursor-pointer transition">
                  Buy
                </button>
              </td>
            </tr>
